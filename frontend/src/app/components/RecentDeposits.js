...
export default function RecentDeposits({ selectedAsset }) {
  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-md border border-indigo-100 mt-6">
      <h2 className="text-xl font-semibold text-indigo-600 mb-4">Recent Deposits</h2>
      {isLoading ? (
